...
# XQuartz
# Winetricks
# Homebrew + Dependiencies (wget, samba,)
# Wine + Dependiencies (gecko, mono)
# Winetricks + Dependiencies (gdiplus, msxml6, dotnet20, riched20, corefonts, mfc42)
#
# Variable Settings
# wine = /Users/$u/.visio
# user = /Users/$u/
# wkdir = /Users/$u/Downloads/requirements
...
# Create temp wkdir
mkdir /Users/$u/Downloads/requirements
cd /Users/$u/Downloads/requirements

# Pre-requisite is Install Xcode - this is available from the Apple Store (Interactive Install)
sudo xcodebuild -license
sudo xcode-select --install

# XQuartz - Download and install latest version from website (Interactive Install)
wget https://dl.bintray.com/xquartz/downloads/XQuartz-2.7.9.dmg
sudo hdiutil attach XQuartz-2.7.9.dmg
open /Volumes/XQuartz-2.7.9/XQuartz.pkg
...
WINE_SHARE_PREFIX=/Users/$u/.visio
fi
install_gecko()
{
case $1 in
...
# Install required dependencies for visio using winetricks

env WINEPREFIX=/Users/$u/.visio winetricks gdiplus
env WINEPREFIX=/Users/$u/.visio winetricks msxml6
env WINEPREFIX=/Users/$u/.visio winetricks dotnet20
env WINEPREFIX=/Users/$u/.visio winetricks riched20
env WINEPREFIX=/Users/$u/.visio winetricks corefonts
env WINEPREFIX=/Users/$u/.visio winetricks -q mfc42

# Override settings for "native, gdiplus, msxml6, riched20 making them native" (Interactive)
env WINEPREFIX=~/.visio winecfg

# Remove requirements folder, move cli-start script to Documents folder and copy app to users script folder
# mv visio_start.sh /Users/$u/Documents
# mv MSVisio2010.app /Users/$u/Library/Scripts/
# cd /Users/$u/Downloads
# rm -rf requirements

echo The install finished successfully, next install Viso using the following command #env WINEPREFIX=~/.visio wine /path/to/visio10/setup.exe
